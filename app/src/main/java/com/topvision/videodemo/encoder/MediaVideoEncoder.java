...
import com.topvision.videodemo.util.EncoderDebugger;
...
//    private static  String MIME_TYPE = "OMX.TI.DUCATI1.VIDEO.H264E";
...
//    private Surface mSurface;
    ...
    private byte[] mFrameData = new byte[CameraWrapper.DST_IMAGE_WIDTH
            * CameraWrapper.DST_IMAGE_HEIGHT * 3 / 2];
    Context context;
...
//		}
    ...
    protected void prepare() throws IOException {
        ...
        //获取编码TYPE
//        EncoderDebugger debugger = EncoderDebugger.debug(context, this.mWidth, this.mHeight);
//        MIME_TYPE  = debugger.getEncoderName();
